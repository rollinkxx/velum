...
| 58 | Perbaikan layar utama: judul terpotong (layout_gravity salah pada anak ScrollView), footer dihapus, tata letak dipadatkan agar muat satu layar (808 -> 656 dp) | Tinggi | Selesai tervalidasi (CI run 34681658613 untuk basis) — verifikasi tampilan lewat APK `app-preview` menyusul |
