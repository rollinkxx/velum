...
| 62 | Hapus popup tawaran Always-on VPN & bebas optimasi baterai atas permintaan maintainer (berkas `VelumSetup` + ujinya, memo, string, kueri baterai; pintasan "Selalu aktif" tetap) | Sedang | Selesai tervalidasi (run CI ujung paket 2026-09-12 — id dicatat menyusul) |
| 63 | Baris "Uji terakhir": handshake jadi syarat (keadaan "belum ada data" ≠ kegagalan jaringan), putar endpoint saat handshake tak terjadi, hasil bertahan lintas pembuatan ulang layar, host trace cadangan, diagnostik memuat uji terakhir | Tinggi | Selesai tervalidasi (run CI ujung paket 2026-09-12 — id dicatat menyusul) — **uji perangkat tetap utang** (lihat TODO 56) |
