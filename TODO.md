...
| 70 | Aturan baru AGENTS.md §11 Kejujuran & Anti-Halusinasi atas perintah maintainer ("tambahkan aturan baru supaya agen selalu jujur & tidak mengarang maupun berhalusinasi") | Tinggi | Selesai (commit aturan terpisah; Ringkasan Eksekutif ikut disinkronkan per §10) |
| 71 | Uji perangkat untuk SEMUA perbaikan konkurensi audit: rotasi layar saat menyambung/menguji, putus di tengah pemutaran endpoint, sambung lewat ubin lalu matikan dari latar, perbarui aplikasi saat tunnel UP | Tinggi | Belum — butuh maintainer (tidak bisa diuji dari sandbox); perluasan TODO 56 |
